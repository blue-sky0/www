<?php
/* Smarty version 3.1.32, created on 2026-06-25 08:56:35
  from '/home/sky/www/app/admin/view/analysis.php' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_6a3ced43dbc4a5_88281448',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '05d02f44ac16fa80588a74abb4f31289617f514e' => 
    array (
      0 => '/home/sky/www/app/admin/view/analysis.php',
      1 => 1782377776,
      2 => 'file',
    ),
  ),
...
function content_6a3ced43dbc4a5_88281448 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        ...
        <article>
            ...
            <div class="stats-grid">
                <div class="stat-card stat-blue"><div class="stat-value"><?php echo $_smarty_tpl->tpl_vars['realtime']->value['last_5min'];?>
</div><div class="stat-label">5分钟内活跃</div></div>
                <div class="stat-card stat-green"><div class="stat-value"><?php echo $_smarty_tpl->tpl_vars['realtime']->value['last_1hour'];?>
</div><div class="stat-label">1小时内活跃</div></div>
                <div class="stat-card stat-orange"><div class="stat-value"><?php echo $_smarty_tpl->tpl_vars['realtime']->value['last_24hour'];?>
</div><div class="stat-label">24小时内活跃</div></div>
            </div>
                ...
                <div class="chart-box">
                    ...
                    <div class="scroll-box">
                        <table class="page-table">
                            ...
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['topPages']->value, 'p');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['p']->value) {
?>
                            <tr>
                                <td style="max-width:300px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['p']->value['page_title'])===null||$tmp==='' ? '' : $tmp);?>
"><?php echo $_smarty_tpl->tpl_vars['p']->value['request_url'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['p']->value['pv'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['p']->value['uv'];?>
</td>
                                <td class="text-right"><?php echo intval($_smarty_tpl->tpl_vars['p']->value['avg_time']);?>
</td>
                            </tr>
                            <?php
}
                ...
                <div class="chart-box">
                    ...
                    <div class="scroll-box">
                        <table class="referrer-table">
                            ...
                            <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['referrers']->value, 'r');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['r']->value) {
?>
                            <tr>
                                <td style="max-width:280px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;" title="<?php echo $_smarty_tpl->tpl_vars['r']->value['referer_url'];?>
"><?php echo $_smarty_tpl->tpl_vars['r']->value['referer_url'];?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['r']->value['count'];?>
</td>
                            </tr>
                            <?php
}
...
var option = {
    ...
    legend: { data: ['PV', 'UV'] },
    xAxis: { type: 'category', data: <?php echo $_smarty_tpl->tpl_vars['trendLabels']->value;?>
 },
    ...
    series: [
        {
            ...
            type: 'line',
            smooth: true,
            data: <?php echo $_smarty_tpl->tpl_vars['trendPv']->value;?>
,
        ...
        },
        {
            ...
            type: 'line',
            smooth: true,
            data: <?php echo $_smarty_tpl->tpl_vars['trendUv']->value;?>
,
